...
@section('content')
  <div class="container d-flex flex-column justify-content-center" style="height: 75vh; width:100vw;">
    ...
    @endif
    <form class="row d-flex align-items-center flex-column py-3 w-100" action="{{ route('room.update', $room->id) }}"
